...
Semantic resume screening with multi-factor scoring and ranked shortlists.
...
pip install -e .
python -m resume_screening_agent.cli --help
python -m unittest discover -s tests -v
```

## Project structure
- `src/resume_screening_agent/`: production code
